I mentioned all script first line is the usage of the script, read carefully before execute. test any one or two machines and validate the output then push the script globally
